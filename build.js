                  ...
                  <div class="flex items-start justify-between gap-3 pb-3">
                    <div class="flex items-center gap-3">
                      <img src="${rel.logoUrl || rel.logo}" alt="${rel.name}" loading="lazy" width="40" height="40"
                           class="w-10 h-10 rounded-xl object-contain bg-zinc-900 border border-zinc-700/60 p-1 shrink-0" 
                           onerror="this.src='${relPath}logo.jpg'" />
                      <div>
      ...
      <main class="flex-1 space-y-8 min-w-0">
        ...
        <div id="section-home" class="space-y-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div id="featured-card-container"
              class="md:col-span-2 md:row-span-3 glass-panel border-indigo-500/30 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between group shadow-2xl">
              <div class="relative z-10">
                ...
                <h2 class="text-3xl font-bold mt-4 text-white">${featuredTool.name}</h2>
              ...
              <div class="flex items-center gap-3 z-10 mt-6">
                ...
                <a href="${featuredTool.officialWebsiteUrl || featuredTool.officialUrl || featuredTool.websiteUrl}" target="_blank" rel="noopener noreferrer" class="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg text-sm font-semibold border border-white/10 transition-colors text-white">
                  Visit Site
                </a>
              </div>
            ...
            <!-- Trending Tool 1 -->
            <div class="md:col-span-1 md:row-span-2 glass-card rounded-2xl p-5 flex flex-col justify-between">
              <div>
                ...
                <a href="tools/${trendingTools[0].slug}/index.html" class="font-bold text-white hover:text-indigo-400 transition-colors">${trendingTools[0].name}</a>
              ...
              <div class="pt-4 flex items-center justify-between border-t border-zinc-800/60 mt-2">
                ...
                <a href="tools/${trendingTools[0].slug}/index.html" class="text-xs text-indigo-400 hover:underline">View Details</a>
              </div>
            </div>
            ...
            <div class="md:col-span-1 md:row-span-2 glass-card rounded-2xl p-5 flex flex-col justify-between">
              <div>
                ...
                <a href="tools/${trendingTools[1].slug}/index.html" class="font-bold text-white hover:text-indigo-400 transition-colors">${trendingTools[1].name}</a>
              ...
              <div class="pt-4 flex items-center justify-between border-t border-zinc-800/60 mt-2">
                ...
                <a href="tools/${trendingTools[1].slug}/index.html" class="text-xs text-indigo-400 hover:underline">View Details</a>
              </div>
            </div>
